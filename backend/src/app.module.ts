...
@Module({
  ...
  TypeOrmModule.forFeature([User, Role, Country, Guest, News, Organization, Player, RecommendScore, Record, Sport, SportToCountry, Team, Tournament]),
  ],
  controllers: [AppController, UserController, RoleController, CountryController, GuestController, NewsController, 
    OrganizationController, PlayerController, RecommendController, RecordController, SportController, 
  ...
  providers: [AppService, UserService, RoleService, CountryService, GuestService, NewsService, 
    OrganizationService, PlayerService, RecommendService, RecordService, SportService, 
